...
class Auth with ChangeNotifier {
  ...
  Future<void> _authenticate(
    ...
    final url =
        'https://identitytoolkit.googleapis.com/v1/accounts:$urlSegment?key=AIzaSyAFmPi0otFMdJ6JZkfDf8YaBwgqAjWC7xE';
    try {
  ...
  Future<bool> _tryRefresh() async {
    ...
    final url =
        'https://securetoken.googleapis.com/v1/token?key=AIzaSyAFmPi0otFMdJ6JZkfDf8YaBwgqAjWC7xE';
    final response = await http.post(
      url,
      body: jsonEncode(
        {
